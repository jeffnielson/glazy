...
$api->version('v1', function (Router $api) {
    ...
    $api->group(['prefix' => 'recipes'], function(Router $api) {
        $api->get('/parentOptions/{material_type_id}', 'App\\Api\\V1\\Controllers\\Glazy\\MaterialController@parentMaterialOptions')->name('parentMaterialOptions');
    ...
    $api->group(['prefix' => 'usermaterials'], function(Router $api) {
        $api->get('/editList', 'App\\Api\\V1\\Controllers\\Glazy\\UserMaterialController@editMaterialList')->name('editList');
        $api->group(['middleware' => 'jwt.auth'], function (Router $api) {
            $api->get('/searchNonInventoryUserMaterials', 'App\\Api\\V1\\Controllers\\Glazy\\UserMaterialController@getPrimitiveMaterialsNotInInventory')->name('searchNonInventoryUserMaterials');
